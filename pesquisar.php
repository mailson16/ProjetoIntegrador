...
$result = "select * from Produto WHERE nome_produto LIKE '%$pesquisar%' 
		   and status_produto in('A')";
$result_pesquisa = mysqli_query($conexao,$result);
						...
						<table class="table table-dark table-hover responsive">			
							<div id="gallerycontent">		
								<?php
									...
									while ($rows_produto = mysqli_fetch_array($result_pesquisa)){

									    //echo "Pesquisa: ".$rows_produto['nome_produto']."<br>";
										 $pesquisa_produto = $rows_produto['nome_produto'];
										 $produto = $rows_produto['imagem_produto'];
										 $descricao = $rows_produto['descricao_produto'];
										 $quantidade = $rows_produto['quantidade_produto'];
										 $validade = $rows_produto['vencimento_produto'];
										 $preco = $rows_produto['valor_produto'];
									?>
