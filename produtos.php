							...
							<div class="col-md-3">
								<div class="thumbnail">
    								...
    								<div class="caption text-center">
      									...
      									<?php if ($quantidade > 0){?>
											<a href="carrinho.php?add=carrinho&id=<?php echo $id?>" class="btn" role="button" style="background: #ee6565;color: white"><i class="material-icons">shopping_cart</i> Adicionar ao Carrinho</a><?php
